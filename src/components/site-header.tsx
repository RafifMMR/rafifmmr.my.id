...
export const SiteHeader = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="screen-line-before screen-line-after mx-auto flex h-16 items-center justify-between gap-2 border-x border-edge px-2 after:z-1 after:transition-[background-color] sm:gap-4 md:max-w-3xl lg:max-w-7xl"
